...
/**
 * Keeps stats on word count, calculates and logs top words every X second to spout and top list every Y seconds,
 * @author kzkit
 */
public class WordCounterBolt extends BaseRichBolt {
	...
	/** Number of seconds before the top list will be logged to spout. */
